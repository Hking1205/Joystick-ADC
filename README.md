...
This module provides dual-axis analog position sensing using potentiometers, making it ideal for robotics control systems, RC transmitters, and embedded human-machine interfaces.  
...
- Normalize values to range (-1 to +1) for control algorithms<br>
